<?php
  ...
  $bs = $fun->get_one('SELECT * FROM d_bs WHERE id = '.$_GET['id']);
?>
<head>
  <meta charset="UTF-8">
        ...
        <div class="document-container p-3" id="section-to-print">
          ...
          <div class="row mt-5">
            <div class="col-md-4 offset-8">
              <b>Client</b> : <?=$bs['client'];?><br>
              <b>Mobile</b> : <?=$bs['tel'];?><br>
              <b>Adresse</b> : <?=$bs['adresse'];?><br>
              <b>MF</b> : <?=$bs['mf'];?><br>
            </div>
          </div>
          <hr>
          <div class="row">
            <div class="col-md-12 text-right">
              <h5>Sousse, le <?=date_format(date_create($bs['date']),"d/m/Y");?></h5><br>
            </div>
            <div class="col-md-12">
              <h3> BS N°: <?='D-'.sprintf('%06d', $bs['id']);?></h3>
            </div>
          </div>
          ...
          <div class="document-table mt-4">
            <table class="table table-bordered" width="100%">
              ...
              <tbody>
                <?php
                  $t = 0;
                  $ligne = $fun->get_list('SELECT * FROM d_ligne_bs WHERE id_bs = '.$_GET['id']);
