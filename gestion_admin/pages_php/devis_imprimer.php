<?php
  ...
  $devis = $fun->get_one('SELECT * FROM d_devis WHERE id = '.$_GET['id']);
?>
<head>
  <meta charset="UTF-8">
        ...
        <div class="document-container p-3" id="section-to-print">
          ...
          <div class="row mt-5">
            <div class="col-md-4 offset-8">
              <b>Client</b> : <?=$devis['client'];?><br>
              <b>Mobile</b> : <?=$devis['tel'];?><br>
              <b>Adresse</b> : <?=$devis['adresse'];?><br>
              <b>MF</b> : <?=$devis['mf'];?><br>
            </div>
          </div>
          <hr>
          <div class="row">
            <div class="col-md-12 text-right">
              <h5>Sousse, le <?=date_format(date_create($devis['date']),"d/m/Y");?></h5><br>
            </div>
            <div class="col-md-12">
              <h3> devis N°: <?='D-'.sprintf('%06d', $devis['id']);?></h3>
            </div>
          </div>
          ...
          <div class="document-table mt-4">
            <table class="table table-bordered" width="100%">
              ...
              <tbody>
                <?php
                  $t = 0;
                  $ligne = $fun->get_list('SELECT * FROM d_ligne_devis WHERE id_devis = '.$_GET['id']);
